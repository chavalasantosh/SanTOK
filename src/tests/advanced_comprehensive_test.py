...
Charlie Wilson,42,charlie@example.com,Phoenix,"مرحبا بالعالم"'''
    ...
    def test_reconstruction_accuracy(self, dataset_name: str, texts: List[str]) -> Dict[str, Any]:
        ...
        print(f"\n🔍 Testing {dataset_name.upper()} dataset reconstruction accuracy...")
        print("=" * 60)
        ...
        for tokenizer_type in self.tokenizers:
            ...
            for i, text in enumerate(texts):
                try:
                    ...
                    print(f"  ❌ ERROR in {tokenizer_type} for text {i + 1}: {e}")
                    continue
            ...
            print(f"  ✅ {tokenizer_type.upper()}: {accuracy:.1f}% accuracy")
    ...
    def test_performance_benchmark(self, dataset_name: str, texts: List[str]) -> Dict[str, Any]:
        ...
        for tokenizer_type in self.tokenizers:
            ...
            if times:
                ...
                print(f"  ❌ {tokenizer_type.upper()}: No successful runs")
    ...
    def test_memory_efficiency(self, dataset_name: str, texts: List[str]) -> Dict[str, Any]:
        ...
        for tokenizer_type in self.tokenizers:
            print(f"\n💾 Memory test: {tokenizer_type.upper()}...")
    ...
    def run_comprehensive_tests(self):
        ...
        print("🚀 Starting Advanced Comprehensive SanTOK Testing")
        print("=" * 80)
...
def main():
    ...
    print("🚀 SanTOK Advanced Comprehensive Testing Framework")
    print("=" * 80)
